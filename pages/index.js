            ...
            <main className=' bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
              <section className=' min-h-screen'>
                ...
                <nav className='py-10 mb-12 flex justify-between'>
                    <h1 className=' text-xl font-burtons dark:text-slate-200'>developedbyharoon</h1>
                    <ul className=' flex items-center'>
                        
                        <li><BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className=' cursor-pointer text-2xl dark:text-slate-200' /></li>
                        <li><a className=' bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8' href="#">Resume</a></li>
                    </ul>
                </nav>

                <div className=' text-center p-10'>
                    <h2 className=' text-5xl py-2 text-teal-600 font-medium md:text-6xl '>Haroon Albar</h2>
                    <h3 className=' text-2xl py-2 md:text-3xl dark:text-slate-200'>Developer and designer.</h3>
              ...
              <section>
                <div>
                    <h3 className='text-3xl py-10 dark:text-slate-200'>Services that I offer</h3>
              ...
              programming and teaching.
                ...
                {/* Making a card section */}
                <div className='lg:flex gap-10 '>
                    <div className=' text-center shadow-lg p-10 rounded-xl my-10 dark:shadow-cyan-600'>
                        <Image src={design} width={100} height={100}/>
                        <h3 className=' text-lg font-medium pt-8 pb-2 dark:text-slate-200'>Beautiful Designs</h3>
                        <p className='py-2 dark:text-slate-300'>Creating elegant designs suited for your needs following core
                design theory.</p>
                        <h4 className='py-4 text-teal-600 '>Design tools I use</h4>
                        <p className=' text-gray-800  py-1 dark:text-slate-300'>Photoshop</p>
                        <p className=' text-gray-800  py-1 dark:text-slate-300'>Illustrator</p>
